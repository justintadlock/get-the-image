...
Support for this plugin is handled on the Theme Hybrid [support forums](http://themehybrid.com/support).
...
To see all methods and options, refer to the `readme.md` file included with the theme download.
